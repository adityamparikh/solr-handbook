...
5. **At layer 0**, do an exhaustive search of a candidate pool of size efSearch = `efSearchScaleFactor × topK` (the scale factor defaults to 1.0 and is new in Solr 10, SOLR-17928). Return the `topK` closest from that pool.
