...
> - **Metrics.** Dropwizard → OpenTelemetry. Metric names changed from dot-delimited (`SEARCH.requestTimes.p95`) to snake_case (`search_request_times_p95`). Existing Prometheus dashboards will break.
...
sequenceDiagram
    ...
    ZK-->>N2: watch fires
    ZK-->>N3: watch fires
    N2->>ZK: attempt CAS on /leader_elect
    N3->>ZK: attempt CAS on /leader_elect
