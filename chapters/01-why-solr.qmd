...
![The Apache Solr™ logo — a trademark of the Apache Software Foundation, reproduced here descriptively from the project's official logo set (apache.org/logos) to identify the software this book covers. Its use does not imply endorsement by the ASF.](figures/01-why-solr/apache-solr-logo.png){#fig-01-solr-logo width=50% fig-align="center"}
